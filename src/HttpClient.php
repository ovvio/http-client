...
final class HttpClient implements HttpClientInterface
{
    ...
    public function request(Request\RequestInterface $request): Response\ResponseInterface
    {
        ...
        try {
            ...
            $responseStatusCode = Response\Enum\ResponseStatusCode::from($response->getStatusCode());
            $responseBody = $response->getContent();
            $responseHeaders = $response->getHeaders();
        } catch (Throwable $th) {
            throw new Exception\HttpException(message: $th->getMessage(), previous: $th->getPrevious());
            // throw $th;
        }
